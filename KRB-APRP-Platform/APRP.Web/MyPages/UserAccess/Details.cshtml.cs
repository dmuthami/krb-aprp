...
namespace APRP.Web.MyPages.UserAccess
{
    ...
    public class DetailsModel : PageModel
    {
        ...
        public DetailsModel(IUserAccessListService userAccessListService, ILogger<DetailsModel> logger,
        ...
        public async Task<IActionResult> OnGetAsync(long? id)
        {
            ...
            {
                _logger.LogError(Ex, $"UserAccess.Details: {Ex.Message} {Environment.NewLine}");
