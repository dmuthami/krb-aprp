...
namespace APRP.Web.MyPages.RoadConditions
{
    ...
    public class DeleteModel : PageModel
    {
        ...
        public DeleteModel(IRoadConditionService roadConditionService, ILogger<DeleteModel> logger,
        ...
        public async Task<IActionResult> OnGet(long id)
        {
            ...
            {
                _logger.LogError(Ex,$"RoadCondition.Delete: {Ex.Message} {Environment.NewLine}");
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            try
            {
                var roadConditionResponse = await _roadConditionService.RemoveAsync(RoadCondition.ID).ConfigureAwait(true);
                RoadCondition = roadConditionResponse.RoadCondtion;
                return RedirectToPage("./Index");
            }
            catch (System.Exception Ex)
            {
                _logger.LogError(Ex,$"RoadCondition.Delete Error: {Ex.Message} {Environment.NewLine}");
                ModelState.AddModelError(string.Empty, Ex.Message);
                return Page();
            }
        }
