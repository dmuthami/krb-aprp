...
namespace APRP.Web.MyPages.Roles
{
    ...
    public class DeleteModel : PageModel
    {
        ...
        public DeleteModel(IApplicationRolesService applicationRolesService, ILogger<DeleteModel> logger,
        ...
        public async Task<IActionResult> OnGet(string id)
        {
            ...
            {
                _logger.LogError(Ex,$"Roles.Delete: {Ex.Message} {Environment.NewLine}");
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            try
            {
                var applicationRolesResponse = await _applicationRolesService.RemoveAsync(ApplicationRole.Id).ConfigureAwait(true);
                ApplicationRole = applicationRolesResponse.ApplicationRole;
                return RedirectToPage("./Index");
            }
            catch (System.Exception Ex)
            {
                _logger.LogError(Ex,$"Roles.Delete Error: {Ex.Message} {Environment.NewLine}");
                ModelState.AddModelError(string.Empty, Ex.Message);
                return Page();
            }
        }
